...
1. Enter the following comment and click the **Submit review** button.
   ...
   <img width="300" alt="Submit review button" src="https://github.com/jinghou2022-create/skills-review-pull-requests66/blob/main/.github/images/submit-review-button.png?raw=true" />
